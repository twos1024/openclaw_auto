...
- `src-tauri/target/release/bundle/msi/ClawDesk_0.3.0_x64_en-US.msi`
- `src-tauri/target/release/bundle/nsis/ClawDesk_0.3.0_x64-setup.exe`
...
- `ClawDesk_0.3.0_x64-setup.exe` 可静默安装到临时目录
