...
const shellTitleRoutes: Array<{ path: string; titleKey: string }> = [
  ...
  { path: "/chat", titleKey: "chat:page.title" },
  { path: "/agents", titleKey: "agents:page.title" },
  { path: "/models", titleKey: "models:page.title" },
  { path: "/channels", titleKey: "channels:page.title" },
  { path: "/providers", titleKey: "providers:page.title" },
  { path: "/cron", titleKey: "cron:page.title" },
  { path: "/dashboard", titleKey: "navigation:dashboard" },
  { path: "/plugins", titleKey: "plugins:page.title" },
  { path: "/skills", titleKey: "skills:page.title" },
  { path: "/settings", titleKey: "settings:title" },
  { path: "/feedback", titleKey: "feedback:page.title" },
];
